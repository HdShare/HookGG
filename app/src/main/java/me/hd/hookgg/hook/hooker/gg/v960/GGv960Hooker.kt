...
object GGv960Hooker : BaseGGHooker() {
    override val functionMap = mapOf(
        GGLib.addListItems to FuncObj.FuncDetail { this.addListItems() },
        GGLib.alert to FuncObj.FuncDetail { this.alert() },
        GGLib.allocatePage to FuncObj.FuncDetail { this.allocatePage() },
        GGLib.bytes to FuncObj.FuncDetail { this.bytes() },
        GGLib.choice to FuncObj.FuncDetail { this.choice() },
        GGLib.clearList to FuncObj.FuncDetail { this.clearList() },
        GGLib.clearResults to FuncObj.FuncDetail { this.clearResults() },
        GGLib.copyMemory to FuncObj.FuncDetail { this.copyMemory() },
        GGLib.copyText to FuncObj.FuncDetail { this.copyText() },
        GGLib.disasm to FuncObj.FuncDetail { this.disasm() },
        GGLib.dumpMemory to FuncObj.FuncDetail { this.dumpMemory() },
        GGLib.editAll to FuncObj.FuncDetail { this.editAll() },
        GGLib.getActiveTab to FuncObj.FuncDetail { this.getActiveTab() },
        GGLib.getFile to FuncObj.FuncDetail { this.getFile() },
        GGLib.getLine to FuncObj.FuncDetail { this.getLine() },
        GGLib.getListItems to FuncObj.FuncDetail { this.getListItems() },
        GGLib.getLocale to FuncObj.FuncDetail { this.getLocale() },
        GGLib.getRanges to FuncObj.FuncDetail { this.getRanges() },
        GGLib.getRangesList to FuncObj.FuncDetail { this.getRangesList() },
        GGLib.getResults to FuncObj.FuncDetail { this.getResults() },
        GGLib.getResultsCount to FuncObj.FuncDetail { this.getResultsCount() },
        GGLib.getSelectedElements to FuncObj.FuncDetail { this.getSelectedElements() },
        GGLib.getSelectedListItems to FuncObj.FuncDetail { this.getSelectedListItems() },
        GGLib.getSelectedResults to FuncObj.FuncDetail { this.getSelectedResults() },
        GGLib.getSpeed to FuncObj.FuncDetail { this.getSpeed() },
        GGLib.getTargetInfo to FuncObj.FuncDetail { this.getTargetInfo() },
        GGLib.getTargetPackage to FuncObj.FuncDetail { this.getTargetPackage() },
        GGLib.getValues to FuncObj.FuncDetail { this.getValues() },
        GGLib.getValuesRange to FuncObj.FuncDetail { this.getValuesRange() },
        GGLib.gotoAddress to FuncObj.FuncDetail { this.gotoAddress() },
        GGLib.hideUiButton to FuncObj.FuncDetail { this.hideUiButton() },
        GGLib.internal1 to FuncObj.FuncDetail { this.internal1() },
        GGLib.internal2 to FuncObj.FuncDetail { this.internal2() },
        GGLib.internal3 to FuncObj.FuncDetail { this.internal3() },
        GGLib.isClickedUiButton to FuncObj.FuncDetail { this.isClickedUiButton() },
        GGLib.isPackageInstalled to FuncObj.FuncDetail { this.isPackageInstalled() },
        GGLib.isProcessPaused to FuncObj.FuncDetail { this.isProcessPaused() },
        GGLib.isVisible to FuncObj.FuncDetail { this.isVisible() },
        GGLib.loadList to FuncObj.FuncDetail { this.loadList() },
        GGLib.loadResults to FuncObj.FuncDetail { this.loadResults() },
        GGLib.makeRequest to FuncObj.FuncDetail { this.makeRequest() },
        GGLib.multiChoice to FuncObj.FuncDetail { this.multiChoice() },
        GGLib.numberFromLocale to FuncObj.FuncDetail { this.numberFromLocale() },
        GGLib.numberToLocale to FuncObj.FuncDetail { this.numberToLocale() },
        GGLib.processKill to FuncObj.FuncDetail { this.processKill() },
        GGLib.processPause to FuncObj.FuncDetail { this.processPause() },
        GGLib.processResume to FuncObj.FuncDetail { this.processResume() },
        GGLib.processToggle to FuncObj.FuncDetail { this.processToggle() },
        GGLib.prompt to FuncObj.FuncDetail { this.prompt() },
        GGLib.removeListItems to FuncObj.FuncDetail { this.removeListItems() },
        GGLib.removeResults to FuncObj.FuncDetail { this.removeResults() },
        GGLib.require to FuncObj.FuncDetail { this.require() },
        GGLib.saveList to FuncObj.FuncDetail { this.saveList() },
        GGLib.saveVariable to FuncObj.FuncDetail { this.saveVariable() },
        GGLib.searchAddress to FuncObj.FuncDetail { this.searchAddress() },
        GGLib.searchFuzzy to FuncObj.FuncDetail { this.searchFuzzy() },
        GGLib.searchNumber to FuncObj.FuncDetail { this.searchNumber() },
        GGLib.setRanges to FuncObj.FuncDetail { this.setRanges() },
        GGLib.setSpeed to FuncObj.FuncDetail { this.setSpeed() },
        GGLib.setValues to FuncObj.FuncDetail { this.setValues() },
        GGLib.setVisible to FuncObj.FuncDetail { this.setVisible() },
        GGLib.showUiButton to FuncObj.FuncDetail { this.showUiButton() },
        GGLib.skipRestoreState to FuncObj.FuncDetail { this.skipRestoreState() },
        GGLib.sleep to FuncObj.FuncDetail { this.sleep() },
        GGLib.startFuzzy to FuncObj.FuncDetail { this.startFuzzy() },
        GGLib.timeJump to FuncObj.FuncDetail { this.timeJump() },
        GGLib.toast to FuncObj.FuncDetail { this.toast() },
        GGLib.unrandomizer to FuncObj.FuncDetail { this.unrandomizer() },
    )
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val memoryToTmp = GGUtil.getHexValue(memoryTo as Long)
                        sendLog(
                            "gg.internal3($maxOffset, $memoryFromTmp, $memoryToTmp)",
                            if (printReturn) "--[[$result]]" else ""
                        )
                    }
                }.ignoredAllFailure()
