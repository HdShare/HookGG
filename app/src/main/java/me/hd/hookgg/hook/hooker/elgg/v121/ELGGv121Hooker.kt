...
object ELGGv121Hooker : BaseGGHooker() {
    ...
    private fun addListItems() {
        "android.ext.ۣۧۧ۟".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun allocatePage() {
        "android.ext.۟ۧ۠ۡۢ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun bytes() {
        "android.ext.ۣ۟ۧ۠ۡ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getActiveTab() {
        "android.ext.۟ۧ۠ۢ۠".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getRangesList() {
        "android.ext.ۣۧۧۡ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getValuesRange() {
        "android.ext.ۣ۟ۧ۠۟".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun gotoAddress() {
        "android.ext.ۣ۟ۧ۠ۡ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun hideUiButton() {
        "android.ext.ۣ۟ۧ۠ۥ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun prompt() {
        "android.ext.ۦۣۤ۠".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun searchPointer() {
        "android.ext.ۦۤۤ۟".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun timeJump() {
        "android.ext.ۥۡ۠ۧ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun unrandomizer() {
        "android.ext.ۦۣۤۢ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
