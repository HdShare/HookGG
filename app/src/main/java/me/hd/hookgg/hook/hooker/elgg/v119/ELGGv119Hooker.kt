...
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.checkboolean
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.checkdouble
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.checkint
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.checkjstring
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.checklong
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.checktable
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.optboolean
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.optdouble
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.optint
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.optjstring
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.optlong
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.optstring
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.opttable
import me.hd.hookgg.hook.hooker.elgg.v119.ELGGv119VarArgs.tojstring
import me.hd.hookgg.hook.utils.GGUtil

object ELGGv119Hooker : BaseGGHooker() {
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        val varArgs = args(0).any()
                        val text = varArgs.checkjstring(1)
                        val textStr = ELGGv119Util.decryptText(text as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val valueStr = ELGGv119Util.decryptText(value as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        val varArgs = args(0).any()
                        val num = varArgs.tojstring(1)
                        val numStr = ELGGv119Util.decryptText(num as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val differenceStr = ELGGv119Util.decryptText(difference as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val timeStr = ELGGv119Util.decryptText(time as String)
