            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        val varArgs = args(0).any()
                        val text = varArgs.checkjstring(1)
                        val textStr = ELGGv117Util.decryptText(text as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val valueStr = ELGGv117Util.decryptText(value as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        val varArgs = args(0).any()
                        val num = varArgs.tojstring(1)
                        val numStr = ELGGv117Util.decryptText(num as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val differenceStr = ELGGv117Util.decryptText(difference as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val timeStr = ELGGv117Util.decryptText(time as String)
