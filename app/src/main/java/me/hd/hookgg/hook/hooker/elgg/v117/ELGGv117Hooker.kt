...
object ELGGv117Hooker : BaseGGHooker() {
    ...
    private fun choice() {
        "android.ext.ۦۤ۟ۦ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun clearList() {
        "android.ext.ۧۧۢۨ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun clearResults() {
        "android.ext.ۦۤ۟ۥ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun copyMemory() {
        "android.ext.ۦۤ۟ۢ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun copyText() {
        "android.ext.ۦۤ۟ۡ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun disasm() {
        "android.ext.ۧۧۢۥ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun dumpMemory() {
        "android.ext.ۦۤ۟۠".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getActiveTab() {
        "android.ext.۟ۧ۠ۢۢ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getFile() {
        "android.ext.ۧۧۡۧ".toClassOrNull()?.apply {
            method {
                name = "a_"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getSelectedElements() {
        "android.ext.ۧۧۥۤ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getValues() {
        "android.ext.ۧۧۥ۠".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun hideUiButton() {
        "android.ext.ۦۤۡۨ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun multiChoice() {
        "android.ext.ۧۧۤۡ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun numberFromLocale() {
        "android.ext.ۦۤۡۡ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun numberToLocale() {
        "android.ext.۟ۧ۠ۤۡ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun processPause() {
        "android.ext.ۦۤ۠ۦ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun processResume() {
        "android.ext.ۣۧۧۧ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun require() {
        "android.ext.ۦۤۤۥ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun saveList() {
        "android.ext.۟ۧ۠ۥ۟".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun saveVariable() {
        "android.ext.ۧۧۧۤ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun searchAddress() {
        "android.ext.ۦۤ۠ۥ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun searchFuzzy() {
        "android.ext.ۦۤۤۡ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun searchPointer() {
        "android.ext.ۧۧۧ۟".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun skipRestoreState() {
        "android.ext.ۦۣۤۦ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun toast() {
        "android.ext.۟ۧ۠ۦ۟".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun unrandomizer() {
        "android.ext.ۦۣۤۡ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
