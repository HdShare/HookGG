...
object RLGGv2092Hooker : BaseGGHooker() {
    ...
    private fun allocatePage() {
        "android.ext.̴".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun bytes() {
        "android.ext.̵".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun clearList() {
        "android.ext.̹".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun copyMemory() {
        "android.ext.̾".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun copyText() {
        "android.ext.̿".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun disasm() {
        "android.ext.͂".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun dumpMemory() {
        "android.ext.̓".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getActiveTab() {
        "android.ext.͉".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getFile() {
        "android.ext.͋".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getLine() {
        "android.ext.͌".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getListItems() {
        "android.ext.͎".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getLocale() {
        "android.ext.͏".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getRanges() {
        "android.ext.͑".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getSelectedElements() {
        "android.ext.͖".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getSelectedListItems() {
        "android.ext.͗".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getSelectedResults() {
        "android.ext.͘".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getSpeed() {
        "android.ext.͙".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getTargetInfo() {
        "android.ext.͚".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getValuesRange() {
        "android.ext.ͤ".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun gotoAddress() {
        "android.ext.ͥ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun hideUiButton() {
        "android.ext.ͦ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun isClickedUiButton() {
        "android.ext.ͨ".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun isPackageInstalled() {
        "android.ext.ͩ".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun isProcessPaused() {
        "android.ext.ͪ".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun isVisible() {
        "android.ext.ͬ".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun loadList() {
        "android.ext.ͭ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun loadResults() {
        "android.ext.ͮ".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun processKill() {
        "android.ext.҄".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun processPause() {
        "android.ext.҅".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun processResume() {
        "android.ext.҆".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun processToggle() {
        "android.ext.Ԩ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun removeResults() {
        "android.ext.ֈ".toClassOrNull()?.apply {
            method {
                name = "̢"
                paramCount = 1
            }.ignored().hook {
