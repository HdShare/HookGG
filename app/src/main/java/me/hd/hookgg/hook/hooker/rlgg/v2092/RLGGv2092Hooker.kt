...
object RLGGv2092Hooker : BaseGGHooker() {
    override val functionMap = mapOf(
        GGLib.addListItems to FuncObj.FuncDetail(libType = LibType.GGLib, isWarning = true) { addListItems() },
        ...
        RLGGLib.command to FuncObj.FuncDetail(libType = LibType.GGLib) { command() },
        ...
        RLGGLib.getConfig to FuncObj.FuncDetail(libType = LibType.GGLib) { getConfig() },
        ...
        RLGGLib.getProcess to FuncObj.FuncDetail(libType = LibType.GGLib) { getProcess() },
        ...
        GGLib.getValues to FuncObj.FuncDetail(libType = LibType.GGLib, isWarning = true) { getValues() },
        ...
        RLGGLib.isVPN to FuncObj.FuncDetail(libType = LibType.GGLib) { isVPN() },
        ...
        RLGGLib.playVideo to FuncObj.FuncDetail(libType = LibType.GGLib) { playVideo() },
        ...
        RLGGLib.setConfig to FuncObj.FuncDetail(libType = LibType.GGLib) { setConfig() },
        RLGGLib.setProcess to FuncObj.FuncDetail(libType = LibType.GGLib) { setProcess() },
        RLGGLib.setProcessX to FuncObj.FuncDetail(libType = LibType.GGLib) { setProcessX() },
        ...
        GGLib.setValues to FuncObj.FuncDetail(libType = LibType.GGLib, isWarning = true) { setValues() },
