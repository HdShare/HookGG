...
object RLGGv2092Hooker : BaseGGHooker() {
    override val functionMap = mapOf(
        GGLib.addListItems to FuncObj.FuncDetail(true) { addListItems() },
        ...
        RLGGLib.command to FuncObj.FuncDetail { command() },
        ...
        RLGGLib.getConfig to FuncObj.FuncDetail { getConfig() },
        ...
        RLGGLib.getProcess to FuncObj.FuncDetail { getProcess() },
        ...
        GGLib.getValues to FuncObj.FuncDetail(true) { getValues() },
        ...
        RLGGLib.isVPN to FuncObj.FuncDetail { isVPN() },
        ...
        RLGGLib.playVideo to FuncObj.FuncDetail { playVideo() },
        ...
        RLGGLib.setConfig to FuncObj.FuncDetail { setConfig() },
        RLGGLib.setProcess to FuncObj.FuncDetail { setProcess() },
        RLGGLib.setProcessX to FuncObj.FuncDetail { setProcessX() },
        GGLib.setRanges to FuncObj.FuncDetail { setRanges() },
        GGLib.setSpeed to FuncObj.FuncDetail { setSpeed() },
        GGLib.setValues to FuncObj.FuncDetail(true) { setValues() },
