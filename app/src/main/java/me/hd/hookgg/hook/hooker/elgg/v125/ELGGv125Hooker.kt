...
object ELGGv125Hooker : BaseGGHooker() {
    override val functionMap = mapOf(
        ...
        ELGGLib.command to FuncObj.FuncDetail(libType = LibType.GGLib) { command() },
        ...
        ELGGLib.getConfig to FuncObj.FuncDetail(libType = LibType.GGLib) { getConfig() },
        ...
        ELGGLib.getProcess to FuncObj.FuncDetail(libType = LibType.GGLib) { getProcess() },
        ...
        ELGGLib.isVPN to FuncObj.FuncDetail(libType = LibType.GGLib) { isVPN() },
        ...
        ELGGLib.playVideo to FuncObj.FuncDetail(libType = LibType.GGLib) { playVideo() },
        ...
        ELGGLib.setConfig to FuncObj.FuncDetail(libType = LibType.GGLib) { setConfig() },
        ELGGLib.setProcess to FuncObj.FuncDetail(libType = LibType.GGLib) { setProcess() },
        ELGGLib.setProcessX to FuncObj.FuncDetail(libType = LibType.GGLib) { setProcessX() },
