...
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.checkdouble
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.checkint
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.checkjstring
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.checklong
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.checktable
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.optboolean
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.optdouble
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.optint
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.optjstring
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.optlong
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.optstring
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.opttable
import me.hd.hookgg.hook.hooker.elgg.v125.ELGGv125VarArgs.tojstring
import me.hd.hookgg.hook.utils.GGUtil

object ELGGv125Hooker : BaseGGHooker() {
    override val functionMap = mapOf(
        GGLib.addListItems to FuncObj.FuncDetail { addListItems() },
        GGLib.alert to FuncObj.FuncDetail { alert() },
        GGLib.allocatePage to FuncObj.FuncDetail { allocatePage() },
        GGLib.bytes to FuncObj.FuncDetail { bytes() },
        GGLib.choice to FuncObj.FuncDetail { choice() },
        GGLib.clearList to FuncObj.FuncDetail { clearList() },
        GGLib.clearResults to FuncObj.FuncDetail { clearResults() },
        ELGGLib.command to FuncObj.FuncDetail { command() },
        GGLib.copyMemory to FuncObj.FuncDetail { copyMemory() },
        GGLib.copyText to FuncObj.FuncDetail { copyText() },
        GGLib.disasm to FuncObj.FuncDetail { disasm() },
        GGLib.dumpMemory to FuncObj.FuncDetail { dumpMemory() },
        GGLib.editAll to FuncObj.FuncDetail { editAll() },
        GGLib.getActiveTab to FuncObj.FuncDetail { getActiveTab() },
        ELGGLib.getConfig to FuncObj.FuncDetail { getConfig() },
        GGLib.getFile to FuncObj.FuncDetail { getFile() },
        GGLib.getLine to FuncObj.FuncDetail { getLine() },
        GGLib.getListItems to FuncObj.FuncDetail { getListItems() },
        GGLib.getLocale to FuncObj.FuncDetail { getLocale() },
        ELGGLib.getProcess to FuncObj.FuncDetail { getProcess() },
        GGLib.getRanges to FuncObj.FuncDetail { getRanges() },
        GGLib.getRangesList to FuncObj.FuncDetail { getRangesList() },
        GGLib.getResults to FuncObj.FuncDetail { getResults() },
        GGLib.getResultsCount to FuncObj.FuncDetail { getResultsCount() },
        GGLib.getSelectedElements to FuncObj.FuncDetail { getSelectedElements() },
        GGLib.getSelectedListItems to FuncObj.FuncDetail { getSelectedListItems() },
        GGLib.getSelectedResults to FuncObj.FuncDetail { getSelectedResults() },
        GGLib.getSpeed to FuncObj.FuncDetail { getSpeed() },
        GGLib.getTargetInfo to FuncObj.FuncDetail { getTargetInfo() },
        GGLib.getTargetPackage to FuncObj.FuncDetail { getTargetPackage() },
        GGLib.getValues to FuncObj.FuncDetail { getValues() },
        GGLib.getValuesRange to FuncObj.FuncDetail { getValuesRange() },
        GGLib.gotoAddress to FuncObj.FuncDetail { gotoAddress() },
        GGLib.hideUiButton to FuncObj.FuncDetail { hideUiButton() },
        GGLib.isClickedUiButton to FuncObj.FuncDetail { isClickedUiButton() },
        GGLib.isPackageInstalled to FuncObj.FuncDetail { isPackageInstalled() },
        GGLib.isProcessPaused to FuncObj.FuncDetail { isProcessPaused() },
        ELGGLib.isVPN to FuncObj.FuncDetail { isVPN() },
        GGLib.isVisible to FuncObj.FuncDetail { isVisible() },
        GGLib.loadList to FuncObj.FuncDetail { loadList() },
        GGLib.loadResults to FuncObj.FuncDetail { loadResults() },
        GGLib.makeRequest to FuncObj.FuncDetail { makeRequest() },
        GGLib.multiChoice to FuncObj.FuncDetail { multiChoice() },
        GGLib.numberFromLocale to FuncObj.FuncDetail { numberFromLocale() },
        GGLib.numberToLocale to FuncObj.FuncDetail { numberToLocale() },
        ELGGLib.playVideo to FuncObj.FuncDetail { playVideo() },
        GGLib.processKill to FuncObj.FuncDetail { processKill() },
        GGLib.processPause to FuncObj.FuncDetail { processPause() },
        GGLib.processResume to FuncObj.FuncDetail { processResume() },
        GGLib.processToggle to FuncObj.FuncDetail { processToggle() },
        GGLib.prompt to FuncObj.FuncDetail { prompt() },
        GGLib.removeListItems to FuncObj.FuncDetail { removeListItems() },
        GGLib.removeResults to FuncObj.FuncDetail { removeResults() },
        GGLib.require to FuncObj.FuncDetail { require() },
        GGLib.saveList to FuncObj.FuncDetail { saveList() },
        GGLib.saveVariable to FuncObj.FuncDetail { saveVariable() },
        GGLib.searchAddress to FuncObj.FuncDetail { searchAddress() },
        GGLib.searchFuzzy to FuncObj.FuncDetail { searchFuzzy() },
        GGLib.searchNumber to FuncObj.FuncDetail { searchNumber() },
        GGLib.searchPointer to FuncObj.FuncDetail { searchPointer() },
        ELGGLib.setConfig to FuncObj.FuncDetail { setConfig() },
        ELGGLib.setProcess to FuncObj.FuncDetail { setProcess() },
        ELGGLib.setProcessX to FuncObj.FuncDetail { setProcessX() },
        GGLib.setRanges to FuncObj.FuncDetail { setRanges() },
        GGLib.setSpeed to FuncObj.FuncDetail { setSpeed() },
        GGLib.setValues to FuncObj.FuncDetail { setValues() },
        GGLib.setVisible to FuncObj.FuncDetail { setVisible() },
        GGLib.showUiButton to FuncObj.FuncDetail { showUiButton() },
        GGLib.skipRestoreState to FuncObj.FuncDetail { skipRestoreState() },
        GGLib.sleep to FuncObj.FuncDetail { sleep() },
        GGLib.startFuzzy to FuncObj.FuncDetail { startFuzzy() },
        GGLib.timeJump to FuncObj.FuncDetail { timeJump() },
        GGLib.toast to FuncObj.FuncDetail { toast() },
        GGLib.unrandomizer to FuncObj.FuncDetail { unrandomizer() },
    )
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        val varArgs = args(0).any()
                        val text = varArgs.checkjstring(1)
                        val textStr = ELGGv125Util.decryptText(text as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val valueStr = ELGGv125Util.decryptText(value as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        val varArgs = args(0).any()
                        val num = varArgs.tojstring(1)
                        val numStr = ELGGv125Util.decryptText(num as String)
                ...
                method {
                    ...
                    after {
                        val funcName = GGUtil.getFuncName(
                            instanceClass,
                            "android.ext.۟ۧ۠ۥ۠".toClassOrNull(),
                            "gg.refineAddress",
                            "gg.searchAddress"
                        )
                        val varArgs = args(0).any()
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val differenceStr = ELGGv125Util.decryptText(difference as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        val funcName = GGUtil.getFuncName(
                            instanceClass,
                            "android.ext.ۦۤۤۥ".toClassOrNull(),
                            "gg.refineNumber",
                            "gg.searchNumber"
                        )
                        val varArgs = args(0).any()
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val timeStr = ELGGv125Util.decryptText(time as String)
