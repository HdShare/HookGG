...
object ELGGv122Hooker : BaseGGHooker() {
    ...
    private fun allocatePage() {
        "android.ext.۟ۧ۠ۡ۟".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun bytes() {
        "android.ext.۟ۧ۠ۡۤ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun disasm() {
        "android.ext.ۧۧۢۤ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun dumpMemory() {
        "android.ext.ۣۧۧۢ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getActiveTab() {
        "android.ext.۟ۧ۠ۢۡ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getLocale() {
        "android.ext.۟ۧ۠ۢۨ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getSelectedResults() {
        "android.ext.ۥۡ۟۟".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getTargetPackage() {
        "android.ext.ۦۤۢۢ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun getValuesRange() {
        "android.ext.ۣ۟ۧ۠۠".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun gotoAddress() {
        "android.ext.ۦۤۢ۟".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun hideUiButton() {
        "android.ext.ۣ۟ۧ۠ۦ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun isClickedUiButton() {
        "android.ext.ۧۧۤۦ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun isProcessPaused() {
        "android.ext.ۧۧۤۧ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun isVisible() {
        "android.ext.ۦۤۡۥ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun loadResults() {
        "android.ext.ۧۧۤۢ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun numberToLocale() {
        "android.ext.۟ۧ۠ۤ۟".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun processToggle() {
        "android.ext.ۦۤ۠ۧ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun removeListItems() {
        "android.ext.ۦۣۤۤ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun saveVariable() {
        "android.ext.ۥۡۡۤ".toClassOrNull()?.apply {
            method {
                name = "b"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun searchAddress() {
        "android.ext.ۦۤ۠ۢ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun startFuzzy() {
        "android.ext.ۧۧۦۨ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun timeJump() {
        "android.ext.ۥۡ۠ۤ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
    ...
    private fun unrandomizer() {
        "android.ext.ۥۡ۠ۡ".toClassOrNull()?.apply {
            method {
                name = "d"
                paramCount = 1
            }.ignored().hook {
