...
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.arg
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.checkboolean
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.checkdouble
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.checkint
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.checkjstring
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.checklong
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.checktable
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.optboolean
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.optdouble
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.optint
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.optjstring
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.optlong
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.optstring
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.opttable
import me.hd.hookgg.hook.hooker.elgg.v122.ELGGv122VarArgs.tojstring
import me.hd.hookgg.hook.utils.GGUtil

object ELGGv122Hooker : BaseGGHooker() {
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        val varArgs = args(0).any()
                        val text = varArgs.checkjstring(1)
                        val textStr = ELGGv122Util.decryptText(text as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val valueStr = ELGGv122Util.decryptText(value as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        val varArgs = args(0).any()
                        val num = varArgs.tojstring(1)
                        val numStr = ELGGv122Util.decryptText(num as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val differenceStr = ELGGv122Util.decryptText(difference as String)
            ...
            .toClassOrNull()?.apply {
                method {
                    ...
                    after {
                        ...
                        val timeStr = ELGGv122Util.decryptText(time as String)
